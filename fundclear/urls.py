...
urlpatterns = patterns('',
    ...
    url(r'^task/update/(?P<fund_id>\w+(-\w+)?)/$', 'fundclear.tasks.update_taskhandler'),
    url(r'^task/update_test/(?P<fund_id>\w+(-\w+)?)/$', 'fundclear.tasks.update_test'),
    ...
    url(r'^task/erase_all/$', 'fundclear.tasks.erase_model_all'),

    url(r'^flot/(?P<fund_id>\w+(-\w+)?)/$', 'fundclear.views.flot_axes_time_view'),
    ...
    #url(r'^func/test/$', 'fundclear.tests.test_movingaverage'),
    #url(r'^func/test/$', 'fundclear.tests.test_standard_deviation'),
    url(r'^func/test/$', 'fundclear.tests.test_bollinger_band'),
