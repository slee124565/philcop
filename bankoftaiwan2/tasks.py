...
def ex_chain_update_taskhandler(request):
    '''
    TODO: update currency year exchange rate and add next chain_update task until year 2007 
    '''
    ...
    try:
        ...
        if not bot.BotExchangeDataModel._update_from_web(p_currency,p_yr_since):
